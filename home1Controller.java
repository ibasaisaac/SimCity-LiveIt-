...
public class home1Controller implements Initializable {
    ...
    @FXML
    private void accomodationIsPressed(MouseEvent event) throws IOException {
        try {
    ...
    @FXML
    private void jobIsPressed(MouseEvent event) throws IOException {
        Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
        Scene scene = new Scene(FXMLLoader.load(getClass().getResource("job.fxml")));
        stage.setScene(scene);
        stage.show();
    }

    @FXML
    private void libraryIsPressed(MouseEvent event) throws IOException {
        Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
        Scene scene = new Scene(FXMLLoader.load(getClass().getResource("library.fxml")));
        stage.setScene(scene);
        stage.show();
    }
